...
class NoneFrontEnd(nn.Module):
    def __init__(self) -> None:
        super().__init__()
        logger.info("NoneFrontEnd initialized")


    def forward(self, input_tensor):
        return input_tensor
    
    def get_output_vectors_dimension(self, input_dimensions):

        return input_dimensions


class VGG(nn.Module):
    def __init__(self, vgg_n_blocks, vgg_channels) -> None:
        super().__init__()
        logger.info("VGG initialized")
    ...
    def get_output_vectors_dimension(self, input_dimension) -> int:
        """
        ...
        * This method is required in model.py.
        """
